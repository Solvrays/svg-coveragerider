...
import { fetchBeneficiary, fetchPolicy, deleteBeneficiary } from '@/lib/services/apiClient';
...
export default function BeneficiaryDetail() {
  ...
  const handleDelete = async () => {
    if (!confirm(`Remove ${beneficiary.firstName} ${beneficiary.lastName} as a beneficiary? This cannot be undone.`)) {
      return;
    }
        ...
        <div className="bg-white shadow overflow-hidden sm:rounded-lg mb-6">
          <div className="px-4 py-5 sm:px-6 flex justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              >
                {isDeleting ? 'Removing...' : 'Remove Beneficiary'}
              </button>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            ...
            <div className="border-t border-gray-200 px-4 py-5 sm:p-0">
              <dl className="sm:divide-y sm:divide-gray-200">
                ...
                <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  <dt className="text-sm font-medium text-gray-500">Beneficiary Type</dt>
                  <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                    {beneficiary.beneficiaryType || 'Primary'}
                  </dd>
                </div>
                <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  <dt className="text-sm font-medium text-gray-500">Per Stirpes</dt>
                  <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                    {beneficiary.perStirpes ? 'Yes' : 'No'}
                  </dd>
                </div>
              </dl>
            </div>
